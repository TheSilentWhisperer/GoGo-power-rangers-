...
func (app *App) HighlightedIntersections(_ *ebiten.Image) []environment.Position {
...
func (app *App) DrawGrid(ebiten_image *ebiten.Image) {
	...
	var highlighted_positions []environment.Position = app.HighlightedIntersections(ebiten_image)
